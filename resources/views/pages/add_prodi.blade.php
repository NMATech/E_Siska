...
@section('content')
    <div>
        <h1 class="text-lg font-bold">TAMBAH PRODI</h1>
    </div>
    <div class="mt-14">
        <form action="{{ route('admin.add_prodi') }}" class="max-w-none mx-auto" method="POST">
            @csrf
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <select id="nama_fakultas" name="nama_fakultas"
                    ...
                    <option value="Fakultas Keguruan dan Ilmu Pendidikan">Fakultas Keguruan dan Ilmu Pendidikan
                    </option>
                    <option value="Fakultas Ilmu Komputer">Fakultas Ilmu Komputer</option>
                    <option value="Fakultas Teknik">Fakultas Teknik</option>
                    <option value="Fakultas Hukum">Fakultas Hukum</option>
                    <option value="Fakultas Ilmu Sosial dan Ilmu Politik">Fakultas Ilmu Sosial dan Ilmu Politik
                    </option>
